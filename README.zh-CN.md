...
PhotosMove 是一个**一键**照片和视频迁移工具：一次操作把 1,600+ 张 / 20GB+ 的照片和视频字节级原样从手机搬到电脑。不管你叫它迁移、备份、导出，还是"把手机照片传到电脑上"——只要你要无损、不联网，PhotosMove 都能搞定。
...
▶️ [观看完整演示视频（36 秒，MP4）](store/demo.mp4)
...
- 🚀 **20GB+ 一次搬完** —— 单个流式 ZIP 下载，按相册可单独重传，ZIP64 支持单文件 > 4GB
...
<p align="center">
  <img src="store/screenshots/01-main-running-zh.png?v=3" alt="App 运行" height="520">
</p>
...
- **能一次传 20GB+ 吗？** 可以。流式 ZIP + ZIP64，已在真实大库上验证。
